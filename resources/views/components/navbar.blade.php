<nav class="fixed top-0 left-[15%] right-[15%] z-50 flex justify-end bg-white text-black p-3 shadow-md font-sans antialiased dark:bg-black dark:text-white/50 rounded-b-lg">
